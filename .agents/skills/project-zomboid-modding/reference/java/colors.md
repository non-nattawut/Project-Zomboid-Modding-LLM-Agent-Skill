...
Available colors accessible from Lua code or usable inside Scripts. Custom colors can be defined with the [colors ](https://pz-wiki-modding.github.io/PZ-API-Docs/scripts/colors.html) block.
